...
Connect Obsidian to Claude Code — shares your selections and open files with the CLI

https://github.com/user-attachments/assets/79c7e68f-accd-42a8-9508-6d5953aa90c4

## Install

> Community plugin submission is pending review. For now, install manually.
...
3. Enable in Obsidian: Settings → Community plugins → Installed plugins → toggle on Obsidian IDE
